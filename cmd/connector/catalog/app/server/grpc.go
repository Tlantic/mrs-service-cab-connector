...
func NewGRPCServer(listenAddr string, service proto.MRSCatalogConnectorExternalServer) Server {
	...
	proto.RegisterMRSCatalogConnectorExternalServer(server, service)
